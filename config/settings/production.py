...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=[".bizwallet.org", "66.29.143.134", "172.17.0.13"])
...
AWS_S3_DOWNLOAD_EXPIRE = 5000
AWS_S3_FILE_EXPIRE = 200
...
# STATIC
# ------------------------
STATICFILES_STORAGE = "bizwallet.utils.storages.StaticRootS3Boto3Storage"
COLLECTFAST_STRATEGY = "collectfast.strategies.boto3.Boto3Strategy"
STATIC_URL = f"https://{aws_s3_domain}/static/"
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "bizwallet.utils.storages.MediaRootS3Boto3Storage"
...
ADMIN_FILEBROWSER_URL = env(
    "DJANGO_ADMIN_FILEBROWSER_URL", default="dashboard/filebrowser/"
)
